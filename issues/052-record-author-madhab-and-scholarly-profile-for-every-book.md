# Record author madhab and scholarly profile for every book
...
- Author/source: all
- Notes: Every book metadata record must include author madhab where known, field, methodology profile, author background, and source confidence.
